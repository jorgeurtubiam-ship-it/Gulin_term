...
Gulin는 macOS, Linux, Windows에서 동작하는 오픈소스 AI 통합 터미널입니다. 어떤 AI 모델과도 함께 사용할 수 있습니다. OpenAI, Claude, Gemini는 API 키를 직접 연결해 사용할 수 있고, Ollama 및 LM Studio를 통해 로컬 모델도 실행할 수 있습니다. 계정 생성은 필요하지 않습니다.

또한 Gulin는 네트워크 중단이나 재시작 이후에도 유지되는 내구성 있는 SSH 세션을 지원하며, 자동 재연결 기능을 제공합니다. 내장 그래픽 에디터로 원격 파일을 편집하고, 터미널을 벗어나지 않고도 파일을 인라인으로 미리볼 수 있습니다.

![GuLiN Screenshot](./assets/gulin-screenshot.webp)

## 주요 기능

- Gulin AI - 터미널 출력과 위젯을 이해하고 파일 작업까지 수행할 수 있는 컨텍스트 인지형 터미널 어시스턴트
- 내구성 있는 SSH 세션 - 연결 끊김, 네트워크 변경, Gulin 재시작 상황에서도 자동 재연결로 세션 유지
...
Gulin AI는 워크스페이스 맥락을 이해하는 터미널 어시스턴트입니다.
...
자세한 내용은 [Gulin AI 문서](https://docs.gulin.dev/gulinai)와 [Gulin AI Modes 문서](https://docs.gulin.dev/gulinai-modes)를 참고하세요.

## 설치

Gulin Terminal은 macOS, Linux, Windows에서 동작합니다.

플랫폼별 설치 방법은 [여기](https://docs.gulin.dev/gettingstarted)에서 확인할 수 있습니다.

직접 다운로드하여 설치하려면 [www.gulin.dev/download](https://www.gulin.dev/download)을 이용하세요.

### 최소 요구 사항

Gulin Terminal은 다음 플랫폼에서 실행됩니다.
...
- 홈페이지 &mdash; https://www.gulin.dev
- 다운로드 페이지 &mdash; https://www.gulin.dev/download
- 문서 &mdash; https://docs.gulin.dev
- X &mdash; https://x.com/gulindev
- Discord 커뮤니티 &mdash; https://discord.gg/XfvZ334gwU

## 소스에서 빌드

[Building Gulin Terminal](BUILD.md)을 참고하세요.

## 기여하기

Gulin는 GitHub Issues를 이슈 추적에 사용합니다.

[기여 가이드](CONTRIBUTING.md)에서 더 많은 정보를 확인할 수 있습니다.

- [기여 방법](CONTRIBUTING.md#contributing-to-gulin-terminal)
- [기여 가이드라인](CONTRIBUTING.md#high-level-expectations)

## 라이선스

Gulin Terminal은 Apache-2.0 라이선스를 따릅니다. 의존성 정보는 [여기](./ACKNOWLEDGEMENTS.md)에서 확인할 수 있습니다.
