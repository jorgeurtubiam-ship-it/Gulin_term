...
type MetaTSType struct {
	...
	// for tabs+gulinai
	GulinAiPanelOpen     bool   `json:"gulinai:panelopen,omitempty"`
	GulinAiPanelWidth    int    `json:"gulinai:panelwidth,omitempty"`
	GulinAiModel         string `json:"gulinai:model,omitempty"`
	GulinAiChatId        string `json:"gulinai:chatid,omitempty"`
	GulinAiWidgetContext *bool  `json:"gulinai:widgetcontext,omitempty"` // default is true
