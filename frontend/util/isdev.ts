...
export const GulinDevVarName = "GULIN_DEV";
export const GulinDevViteVarName = "GULIN_DEV_VITE";
 ...
 */
export const isDev = lazy(() => !!getEnv(GulinDevVarName));
 ...
 */
export const isDevVite = lazy(() => !!getEnv(GulinDevViteVarName));
