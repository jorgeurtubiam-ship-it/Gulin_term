# Contributing to Gulin Terminal

Gulin Terminal is an opinionated project with a single active maintainer. Contributions are welcome, but **alignment matters more than volume**.
...
- Gulin has a strong product direction and centralized ownership.
...
- Gulin is not designed as a "first open source contribution" project
...
To build and run Gulin locally, see instructions at [Building Gulin Terminal](./BUILD.md).
...
Thank you for your interest in Gulin Terminal. Clear expectations help keep the project moving quickly and sustainably.
