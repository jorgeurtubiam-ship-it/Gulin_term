...
Supported URI schemes:
  wsh:
    ...
    for file streaming to Gulin and other remotes.
    ...
    If a profile is provided, it must be defined in "profiles.json" in the Gulin
...
Gulin Terminal is capable of managing files from remote SSH hosts and your local
...
var fileInfoCmd = &cobra.Command{
	Use:     "info [uri]",
	Short:   "show gulin file information",
